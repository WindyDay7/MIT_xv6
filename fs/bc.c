...
{
	// utf_fault_va is the address that bc_pgfault happpened
	void *addr = (void *) utf->utf_fault_va;
	// block number we read from disk
	...
	// Sanity check the block number. if block number out of 
	// total the block number of disk 
